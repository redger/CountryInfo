...
public enum CountryInfo {
	...
	GBR("GB", 826,   "G", "UK", "GBR",    "",  "GB", "UK", "256", "xxk", "44", "United Kingdom", "Yes"),
	...
	MNE("ME", 499, "MNE", "MJ", "MGO", "MNE",    "",   "", "2647", "mo", "382", "Montenegro", "Yes"),
	...
	UMI("UM", 581,    "",   "",    "",    "", "USA",   "",    "",   "",    "", "United States Minor Outlying Islands", "Territories of US"),
...
//	{
//		final String frm = "%2s, %8s, %3d, %8s, %8s, %8s, %8s, %8s, %8s, %8s, %8s, %8s, %s, %s\n";
//		
//		for(CountryInfo ci : values())
//		{
//			System.out.println( 
...
//	}
	...
	public static final int VERSION = 20130219;
}
